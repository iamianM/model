...
# keras-rl agent
from rl_new.agents.dqn import DQNAgent
from rl_new.policy import BoltzmannQPolicy, EpsGreedyQPolicy
from rl_new.memory import SequentialMemory
...
#     dqn.load_weights('./model/duel__LSTM_dqn_OHLCV-v0_weights_1044LS_0_19_0.04339342066576202.h5f')
    history = dqn.fit(env, nb_steps=800000, nb_max_episode_steps=None, visualize=False, verbose=0)
    # validate
    info = dqn.test(env_test, nb_episodes=1, visualize=True, verbose=0)
